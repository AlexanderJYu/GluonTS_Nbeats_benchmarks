...
def generate_lstnet_dataset(dataset_path: Path, dataset_name: str, numpyfile: str):
...
if __name__ == "__main__":
    generate_lstnet_dataset(Path('.'), "traffic_nbeats_last7days_predlen1", './traffic.npy')
    '''dataset_path = Path('.')
    dataset = load_datasets(
        metadata=dataset_path,
        train=dataset_path / "traffic_nbeats_last7days_predlen1" / "train",
        test=dataset_path / "traffic_nbeats_last7days_predlen1" / "test",
    )
