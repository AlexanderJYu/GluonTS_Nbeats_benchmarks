...
class myInstanceSplitter(FlatMapTransformation):
    """
    ...
    def __init__(
        ...
        l_h: int = None, # nbeats sampling coefficient
    ) -> None:
    ...
    def flatmap_transform(
        ...
        if is_train:
            lower_bound = (len_target - self.l_h * self.future_length) if self.l_h != None else 0
            sampling_bounds = (
                (
                    lower_bound,
