...
def generate_lstnet_dataset(dataset_path: Path, dataset_name: str):
    ...
    train_file = dataset_path / "traffic_nbeats_last7days" / "train" / "data.json"
    test_file = dataset_path / "traffic_nbeats_last7days" / "test" / "data.json"
...
if __name__ == "__main__":
    generate_lstnet_dataset(Path('.'), "traffic_nbeats_last7days")
    '''dataset_path = Path('.')
    dataset = load_datasets(
        metadata=dataset_path,
        train=dataset_path / "traffic_nbeats_last7days" / "train",
        test=dataset_path / "traffic_nbeats_last7days" / "test",
    )
