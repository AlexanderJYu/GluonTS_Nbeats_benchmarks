...
# name = "tourism_monthly_predlen12"
...
estimator = myNBEATSEnsembleEstimator(
    ...
    meta_context_length=[pred_len*multiplier for multiplier in range(2, 8)],
...
predictor.serialize(Path("./nips_datasets/" + name + "/ensemble_batch300_predlen24"))
with open("./nips_datasets/" + name + "/" + name + "_Yhats.pkl", "wb") as f:
    pickle.dump(Yhats, f)
